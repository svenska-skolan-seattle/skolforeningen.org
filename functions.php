	...
	$starter_content = array(
		...
		'attachments' => array(
			'image-espresso' => array(
				'post_title' => _x( 'Espresso', 'Theme starter content', 'svenskaskolaniseattle' ),
				'file'       => 'assets/images/espresso.jpg', // URL relative to the template directory.
			),
			'image-sandwich' => array(
				'post_title' => _x( 'Sandwich', 'Theme starter content', 'svenskaskolaniseattle' ),
				'file'       => 'assets/images/sandwich.jpg',
			),
			'image-coffee'   => array(
				'post_title' => _x( 'Coffee', 'Theme starter content', 'svenskaskolaniseattle' ),
...
function twentyseventeen_fonts_url() {
	 ...
	 */
	$libre_franklin = _x( 'on', 'Libre Franklin font: on or off', 'svenskaskolaniseattle' );
...
function twentyseventeen_scripts() {
	...
	if ( has_nav_menu( 'top' ) ) {
		...
		$twentyseventeen_l10n['expand']   = __( 'Expand child menu', 'svenskaskolaniseattle' );
		$twentyseventeen_l10n['collapse'] = __( 'Collapse child menu', 'svenskaskolaniseattle' );
