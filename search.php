...
<div class="wrap">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'svenskaskolaniseattle' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
		<?php else : ?>
	...
	<div id="primary" class="content-area">
		...
		?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'svenskaskolaniseattle' ); ?></p>
			<?php
				get_search_form();
