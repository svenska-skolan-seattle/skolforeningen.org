...
if ( ! function_exists( 'twentyseventeen_time_link' ) ) :
	...
	function twentyseventeen_time_link() {
		...
		return sprintf(
			...
			__( '<span class="screen-reader-text">Posted on</span> %s', 'svenskaskolaniseattle' ),
	...
	function twentyseventeen_edit_link() {
		edit_post_link(
			sprintf(
				...
				__( 'Edit<span class="screen-reader-text"> "%s"</span>', 'svenskaskolaniseattle' ),
				get_the_title()
			),
